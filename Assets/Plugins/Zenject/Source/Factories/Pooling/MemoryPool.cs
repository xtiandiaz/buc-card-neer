namespace Zenject
{
        ...
        : MemoryPoolBase<TValue>, IMemoryPool<TParam1, TValue>, IFactory<TParam1, TValue>
    {
        ...
        TValue IFactory<TParam1, TValue>.Create(TParam1 withType)
        {
            return Spawn(withType);
        }
    }
        ...
        : MemoryPoolBase<TValue>, IMemoryPool<TParam1, TParam2, TValue>, IFactory<TParam1, TParam2, TValue>
    {
        ...
        TValue IFactory<TParam1, TParam2, TValue>.Create(TParam1 p1, TParam2 inParentView)
        {
            return Spawn(p1, inParentView);
        }
    }
