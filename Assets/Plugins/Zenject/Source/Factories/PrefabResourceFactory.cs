...
namespace Zenject
{
        ...
        //where T : Component
    {
        ...
        public virtual T Create(string withType)
        {
            Assert.That(!string.IsNullOrEmpty(withType),
              "Null or empty prefab resource name given to factory create method when instantiating object with type '{0}'.", typeof(T));

            var prefab = (GameObject)Resources.Load(withType);
        ...
        //where T : Component
    {
        ...
        public virtual T Create(string prefabResourceName, P1 inParentView)
        {
